...
open class ImageScrollView: UIScrollView {
    ...
    fileprivate func initialize() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(ImageScrollView.changeOrientationNotification), name: UIResponder.keyboardWillHideNotification, object: nil)
